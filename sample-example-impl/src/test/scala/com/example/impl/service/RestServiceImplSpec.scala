...
//  lazy val mockedProducer = mock[Producer]
...
//      override lazy val producer = mockedProducer
    }
  }
...
//      when(mockedProducer.produceData(Log(anyString(), request, any(response.getClass)), anyString())) thenReturn "TesTopic"
